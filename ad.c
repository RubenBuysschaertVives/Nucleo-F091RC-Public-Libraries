...
void InitAd(void)
{
	...
	// Wachten op einde kalibratie. Op dat moment wordt het register CALFACT geüpdatet.
	// De kalibratie zorgt ervoor dat de eventueel ongewenste offset van de AD-meting, 
	// verwijderd wordt.
