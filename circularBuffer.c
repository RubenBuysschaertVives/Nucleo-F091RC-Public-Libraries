...
// Zoek achter één bepaalde string in het huidige buffer. Na deze functie is het buffer geledigd.
...
// Zoek achter één van twee opgegeven strings in het huidige buffer. Na deze functie is het buffer geledigd.
...
// Zoek achter één van drie opgegeven strings in het huidige buffer. Na deze functie is het buffer geledigd.
...
// Zoek achter de start van een bepaalde string in het huidige buffer. Na deze functie is het buffer geledigd.
bool LookForBeginningOfString(volatile CircularBuffer* circularBuffer, char needle[])
{
	char haystack[CHAR_ARRAY_BUFFER_LENGTH];
	enum CircularBufferActionResult circularBufferActionResult;	
